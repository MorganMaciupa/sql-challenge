# sql-challenge
## Week 09  SQL Homework - Employee Database: A Mystery in Two Parts

###Submission
Uploaded schema and query code as .sql file, ERD as .png file and query responses as .csv files in ~/responses
